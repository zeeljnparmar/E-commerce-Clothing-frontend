      ...
      <div className="contain">
        <div className="flex justify-between flex-wrap gap-y-10">
          ...
          <div className=" basis-[45%] pl-10  850:basis-full">
            ...
            <div className="mt-20 flex gap-x-10 850:justify-between">
              ...
              <div className="border border-gray-200 text-gray-200 basis-1/3 pt-2 pb-2 flex items-center justify-center gap-x-3 1000:basis-2/5">
